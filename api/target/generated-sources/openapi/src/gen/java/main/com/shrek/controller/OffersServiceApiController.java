...
@Controller
@RequestMapping("${openapi.conveyor.base-path:}")
public class OffersServiceApiController implements OffersServiceApi {

    private final NativeWebRequest request;

    @Autowired
    public OffersServiceApiController(NativeWebRequest request) {
